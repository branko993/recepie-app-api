...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_partal_updatee_recipe(self):
        """Test updating a recipe with patch"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        new_tag = sample_tag(user=self.user, name='Curry')

        payload = {'title': 'Chicken brale', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
    ...
    def test_full_updatee_recipe(self):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(self.user, title='Abergine with tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(self.user, title='Thai curry')
        recipe2 = sample_recipe(self.user, title='Chicken')
