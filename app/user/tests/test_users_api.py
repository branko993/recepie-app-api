...
class PublicUserApiTests(TestCase):
    """Test class for public api user tests"""
    ...
    def test_user_exists(self):
        """Test creating user that aldery exists fails"""
        payload = {
            'email': 'test@test.com',
            'password': 'testpass'
        }
    ...
    def test_password_to_short(self):
        """Test that checks if password is to short"""
        payload = {
            'email': 'test@test.com',
            'password': 'pw'
        }
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'branko993@gmail.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        payload = {'email': 'test@test.com', 'password': 'testttt'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_retrieve_user_unauthorized(self):
        """Test is auth required for user"""
